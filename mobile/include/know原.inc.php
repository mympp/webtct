...
if($itemid) {
	...
	if($action == 'list') {
		...
		if($submit) {
			...
			mobile_msg($status == 3 ? $L['answer_success'] : $L['answer_check'], "?moduleid=$moduleid&itemid=$itemid");
		} else {			
			if($TP == 'touch') {
