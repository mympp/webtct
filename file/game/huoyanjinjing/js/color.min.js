...
_config = {
	...
	imgUrl: "http://img.ej120.com/game/hyjj/images/wechat-share-icon.png",
	timeLineLink: "http://www.tecenet.com/file/game/huoyanjinjing/index.html?gameTicket=",
	tTitle: "【火眼金睛】战斗力榜_天成医疗网",
	tContent: "「天成」有彩蛋：冲关25以上有惊喜传送门！"
};
!
function() {
	var a = $("#box"),
		...
		c = {
			...
			wechatShare: function() {
				shareData.tTitle = Game.lastLv > 0 ? "我闯过" + (Game.lastLv) + "关，击败" + Game.lastGamePercent + "%的人！我拥有【" + Game.lastGameTxt + "】的眼睛！不服来战！" : shareData.tTitle;
				        ...
				        if (typeof cb.timestamp != 'undefined' && typeof cb.nonceStr != 'undefined' && typeof cb.signature != 'undefined') {
				            ...
				            wx.ready(function () {
				                wx.onMenuShareTimeline({
				                    ...
				                    link:   shareData.timeLineLink+gameTicket,
			...
			gameOver: function() {
				...
				this.lastLv = this.lv, this.lastGameTxt = d.txt, this.lastGamePercent = d.percent, b.d_share.hide().find("h3").text(this.lastGameTxt), b.d_content.hide(), b.d_gameover.show().find("h3").text(this.lastGameTxt), a.find("span").fadeOut(1e3, function() {
					b.dialog.fadeIn()
				}), this._pause = !0, this.reset(), fb_share(), this.wechatShare()
			},
			reset: function() {
	...
	var b = {
		...
		c = {
			...
			loading: function() {
				...
				} else c.render();window.Game.wechatShare();
			},
			render: function() {
