...
<link rel="stylesheet" href="<?php echo DT_SKIN;?>tecenet.base.css?v201702241543">
<link rel="stylesheet" href="<?php echo DT_SKIN;?>tecenet.index.css?v201705230923">
...
<a class="online  pull-left" href="javascript:;" onclick="javascript:window.open('http://p.qiao.baidu.com/cps/chat?siteId=3215492&amp;userId=6452136&amp;s=tecenet.com','newwindow','height=530,width=600,top=100,left=200,toolbar=no,menubar=no,scrollbars=no,resizeable=no,lacation=no,status=no');">在线咨询</a>
</div>
...
<li class="other">
<a href="javascript:;" target="_self">产品</a>
<div class="sub-nav">
...
<a class="pull-right" href="javascript:window.open('http://p.qiao.baidu.com/cps/chat?siteId=3215492&userId=6452136','newwindow','height=530,width=600,top=100,left=200,toolbar=no,menubar=no,scrollbars=no,resizeable=no,lacation=no,status=no');" target="_blank"><i class="icon"></i>在线客服</a>
</div>
</li>
