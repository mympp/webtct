...
<td class="tab_nav">&nbsp;</td>
<td class="tab dsn" id="Tab1"><a href="javascript:Tab(1);"><span>导航菜单</span></a></td>
<td class="tab_nav dsn">&nbsp;</td>
<td class="tab" id="Tab2"><a href="javascript:Tab(2);"><span>栏目菜单</span></a></td>
<td class="tab_nav">&nbsp;</td>
<td class="tab dsn" id="Tab3" ><a href="javascript:Tab(3);"><span>首页设置</span></a></td>
<td class="tab_nav dsn">&nbsp;</td>
<td class="tab" id="Tab4"><a href="javascript:Tab(4);"><span>高级设置</span></a></td>
<td class="tab_nav">&nbsp;</td>
<td class="tab" id="Tab5"><a href="javascript:Tab(5);"><span>修改申请</span></a></td>
<td class="tab_nav">&nbsp;</td>
</tr>
</table>
</div>
<form method="post" action="home.php" id="dform" onsubmit="return confirm('确定修改网店设置?')">
...
<td class="tr f_gray">
<script type="text/javascript" src="<?php echo DT_PATH;?>file/script/jscolor.js"></script>
<input name="setting[bgcolor]" type="text" size="10" id="bgcolor" class="color {hash:true,required:false}" value="<?php echo $bgcolor;?>"/>&nbsp;&nbsp;<a href="javascript:void(0)" onclick="Dd('bgcolor').value='';Dd('bgcolor').style.backgroundColor='#ffffff'">清除颜色</a></td>
</tr>
<tr>
<td class="tl">自定义LOGO</td>
<td class="tr"><input name="setting[logo]" type="text" size="60" id="logo" value="<?php echo $logo;?>" readonly/><span onclick="Dthumb(<?php echo $moduleid;?>,0,0, Dd('logo').value, true, 'logo');" class="jt">[上传]</span>&nbsp;&nbsp;<span onclick="_preview(Dd('logo').value);" class="jt">[预览]</span>&nbsp;&nbsp;<span onclick="Dd('logo').value='';" class="jt">[删除]</span><br>规格：宽度不大于180，高度不大于90&nbsp;&nbsp;</td>
</tr>
<tr>
...
<table cellspacing="1" cellpadding="6" class="tb"><tr >
<td class="tl">首页模块设置<br/><br/><br/><a href="home.php?action=reset&item=main" class="t" onclick="return confirm('确定要恢复首页主栏为默认吗？');">恢复默认</a></td>
<td class="tr">
...
;">
<td class="tl">网站导航菜单<br/><br/><br/><a href="home.php?action=reset&item=menu" class="t" onclick="return confirm('确定要恢复菜单设置为默认吗？');">恢复默认</a>
<br>
<span  style="font-size:12px;">排序>=8将会放置在下拉菜单中！</span>
</td>
<td class="tr">
<table cellpadding="3" cellspacing="3">
<tr align="center">
...
;">
<td class="tl">侧栏模块设置<br/><br/><br/><a href="home.php?action=reset&item=side" class="t" onclick="return confirm('确定要恢复侧栏位置为默认吗？');">恢复默认</a></td>
<td class="tr">
<table cellpadding="3" cellspacing="3">
<tr align="center">
<td width="50">显示</td>
...
<td class="tr"><textarea name="setting[css]" id="css" style="width:500px;height:60px;overflow:visible;font-family:Fixedsys"><?php echo $css;?></textarea><br>选填内容，专业网页开发人员填写，可以更加优化网店形式。</td>
</tr>
<tr>
<td class="tl">首页SEO标题</td>
<td class="tr f_gray"><input type="text" size="60" name="setting[seo_title]" value="<?php echo $seo_title;?>"/>&nbsp; 留空则显示公司名称<br>可填可不填，一般用在百度搜索的排名结果里显示</td>
</tr>
<tr>
<td class="tl">网站关键词</td>
<td class="tr"><input type="text" size="80" name="setting[seo_keywords]" value="<?php echo $seo_keywords;?>"/><br>可填可不填，一般用在百度搜索的排名结果里显示，填写有助排名</td>
</tr>
<tr>
<td class="tl">网站描述</td>
<td class="tr"><input type="text" size="80" name="setting[seo_description]" value="<?php echo $seo_description;?>"/><br>可填可不填，一般用在百度搜索的排名结果里显示，填写有助排名</td>
</tr>
...
<style>
#company_edit tr td,#company_edit tr th{text-align: center;border-bottom: 1px dashed #ccc;}
iframe[name='company_edit']{height:380px;}
</style>
<table cellspacing="1" cellpadding="6" class="tb" id="company_edit">
<tr>
<th>申请时间</th>
<th>当前状态</th>
<th>修改类型</th>
...
<td><?php if($v['status'] == 3) { ?>已通过<?php } else if($v['status'] == 2) { ?>待审核<?php } else { ?>未通过<?php } ?>
</td>
<td><?php if($v['type'] == 1) { ?>网站设置<?php } ?>
</td>
<td><a href="javascript:void(0);" onclick="divbox('company_edit',1080,'网店设置修改申请内容','home.php?action=company_edit_data&editid=<?php echo $v['itemid'];?>')">[查看]</a></td>
...
<script type="text/javascript">
Dd('bgcolor').className='color {hash:true,required:false}';
</script>