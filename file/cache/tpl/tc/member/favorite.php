...
<td class="tab_nav">&nbsp;</td>
<td class="tab" id="type"><a href="type.php?item=favorite"><span>收藏分类</span></a></td>
</tr>
</table>
</div>
<?php if($action == 'add') { ?>
...
<tr>
<td class="tl">分类 </td>
<td class="tr"><?php echo $type_select;?>&nbsp; <a href="type.php?item=favorite" class="t">[管理分类]</a></td>
</tr>
<tr>
...
<tr>
<td class="tl">&nbsp;</td>
<td class="tr" height="50"><input type="submit" name="submit" value=" 修 改 " class="btn" onmouseover="this.className='btny'" onmouseout="this.className='btn'" />&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value=" 返 回 " class="btn" onmouseover="this.className='btny'" onmouseout="this.className='btn'"  onclick="history.back(-1);"/></td>
</tr>
</table>
</form>
...
<input type="button" value=" 重 置 " class="btn" onmouseover="this.className='btny'" onmouseout="this.className='btn'"  onclick="window.location='favorite.php';"/>
</div>
</form>
<div class="ls">
