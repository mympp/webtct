...
<style type="text/css">
.vt{background:#e7e7e7;}
.vt td{background:#fff;text-align:center}
</style>
<table cellpadding="10" cellspacing="5" width="100%" class="vt">
<Tr>
<?php if($MOD['vemail']) { ?><td><a href="validate.php?action=email" ><img src="<?php echo DT_PATH;?>member/image/v/email<?php if($d['vemail']) { ?>v<?php } ?>
.png"><br>
<?php if($d['vemail']) { ?>已通过<?php } else { ?>未通过<?php } ?>
邮件认证</a> &nbsp;</td><?php } ?>
<?php if($MOD['vmobile']) { ?><td><a href="validate.php?action=mobile" ><img src="<?php echo DT_PATH;?>member/image/v/mobile<?php if($d['vmobile']) { ?>v<?php } ?>
.png"><br>
<?php if($d['vmobile']) { ?>已通过<?php } else { ?>未通过<?php } ?>
手机认证</a> &nbsp;</td><?php } ?>
<?php if($MOD['vbank']) { ?><td><a href="validate.php?action=bank" ><img src="<?php echo DT_PATH;?>member/image/v/bank<?php if($d['vbank']) { ?>v<?php } ?>
.png"><br>
<?php if($d['vbank']) { ?>已通过<?php } else { ?>未通过<?php } ?>
银行认证</a> &nbsp;</td><?php } ?>
<?php if($MOD['vtruename']) { ?><td><a href="validate.php?action=truename" ><img src="<?php echo DT_PATH;?>member/image/v/truename<?php if($d['vtruename']) { ?>v<?php } ?>
.png"><br>
<?php if($d['vtruename']) { ?>已通过<?php } else { ?>未通过<?php } ?>
实名认证</a> &nbsp;</td><?php } ?>
<?php if($MOD['vcompany']) { ?><td><a href="validate.php?action=company" ><img src="<?php echo DT_PATH;?>member/image/v/company<?php if($d['vcompany']) { ?>v<?php } ?>
.png"><br>
