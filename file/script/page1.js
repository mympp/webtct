...
function img_tip(o, i) {
	if(i) {
		if(i.indexOf('nopic.gif') == -1) {
			...
			var X = o.offsetLeft + leftpos + 160;
...
var isMobile = false; 
for (var i=0; i<mobileAgent.length; i++){ if (UA.indexOf(mobileAgent[i])!=-1){ isMobile = true; 
Go(url);
break; } } 
}
...
(function() {
	$(window).bind("scroll.back2top", function() {
        ...
        (st > 0) ? $('#back2top').height('243') : $('#back2top').height('189');         
