...
$L['all_type'] = '所有分类';
$L['choose_type'] = '请选择分类';
$L['check_auth'] = '您的请求未通过系统验证！如未登录，请先登录后再激活！';//global.func
...
$L['member_username_ban'] = '会员登录名含有禁止注册的字符';
...
$L['member_login_ban'] = '累计{V0}次错误尝试 您在1小时内不能登录系统';
...
$L['group_status'] = array(
	'<span style="color:#0000FF;">已参团</span>',
