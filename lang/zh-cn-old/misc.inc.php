...
$L['order_goods'] = '订购产品';
/* job/apply.inc.php */
$L['apply_self'] = '您不能向自己信息报名供应';
$L['apply_again'] = '您已经向此服务需求报名技术服务供应';
$L['apply_title'] = '报名技术服务';
$L['apply_msg_title'] = '您的服务需求[{V0}]收到报名信息';
$L['apply_msg_content'] = '详见:<a href="{V0}" target="_blank">{V0}</a>';
$L['apply_success'] = '报名参加技术服务成功';
$L['make_resume'] = '请先创建技术服务信息';
$L['not_resume'] = '您的技术服务信息不存在';
/* rc_job/apply.inc.php*/
$L['send_rc_self'] = '请不要向自己发布的招聘信息投递简历';
$L['apply_rc_self'] = '您不能向自己发布的招聘信息投递简历';
$L['apply_rc_again'] = '您已经向此招聘职位投递您的个人简历';
$L['apply_rc_title'] = '投递个人简历';
$L['apply_rc_msg_title'] = '您的招聘信息[{V0}]收到投递信息';
$L['apply_rc_msg_content'] = '详见:<a href="{V0}" target="_blank">{V0}</a>';
$L['apply_rc_success'] = '您的简历成功投递到该职位';
$L['make_rc_resume'] = '请先创建个人简历';
$L['not_rc_resume'] = '您的个人简介不存在';
/* konw/answer.inc.php */
$L['vote_end'] = '投票已经结束';
$L['vote_answer'] = '问题投票';
...
/* module/rc_job/apply.inc.php */
$L['resume_message']='您收到一份投递简历,投递人{V0} , {V1} , {V2}';
$L['goto_webindex']='<img src="{V0}" width="20px" height="20px" />&nbsp;&nbsp;<a href="{V1}" ><font style="font-size:18px;line-height:18px;">{V2}</font></a>';
?>