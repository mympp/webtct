...
$L['trade_status'] = array(
	...
	'<span style="color:#888888;text-decoration:line-through;">平台关闭</span>',
);
...
$L['trade_message_close_buyer_t']='站内交易提醒，您有一笔交易已被卖家关闭(T{V0})';               //--2016/3/1/chentao--,卖家关闭交易站内信提醒买家标题
$L['trade_message_close_buyer_c']='卖家 <a href="{V0}" class="t">{V1}</a> 于 <span class="f_gray">{V2}</span> 关闭了您的订单<br/><a href="{V3}" class="t" target="_blank">&raquo; 请点这里立即处理或查看详情</a>。如果该交易已线下付款，请联系卖家线下退款';  						//--2016/3/1/chentao--，卖家关闭交易站内信提醒买家内容
