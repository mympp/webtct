...
class SphinxClient
{
	...
	function SphinxClient ()
	{
		...
		$this->_error		= ""; // per-reply fields (for single-query tycase)
		$this->_warning		= "";
		$this->_connerror	= false;

		$this->_reqs		= array ();	// requests storage (for multi-query tycase)
		$this->_mbenc		= "";
	...
	function Query ( $query, $index="*", $comment="" )
	{
		...
		$this->_reqs = array (); // just in tycase it failed too early
