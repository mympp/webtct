...
if($city) {
	...
	if($city_domain && !defined('DT_ADMIN') && strpos($DT_URL, DT_PATH) !== false && strpos($DT_URL, '/api/') === false && strpos($DT_URL, '/upload.php') === false) dheader(str_replace(DT_PATH, $city_domain, $DT_URL));
} else {
