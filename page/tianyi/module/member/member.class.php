...
class member {
	...
	function edit($member)	{
		...
		$company_fields = array('company','type','areaid', 'catid','catids','business','mode','regyear','regunit','capital','size','address','postcode','telephone','fax','mail','homepage','sell','buy','introduce','thumb','keyword','linkurl','groupid','domain','icp','validated','validator','validtime','skin','template','register','reoffice','readdress','starttime','endtime','retime','legalPerson','mobilePhone','image');
