...
?>
    ...
    <form method="post" action="?">
        ...
        <table cellpadding="2" cellspacing="1" class="tb">
            ...
            <?php }?>
            <?php if(isset($E['register'])) {?>
                <tr onmouseover="this.className='on';" onmouseout="this.className='';">
                    <td align="center"><input type="checkbox" name="pass[]" value="register" checked/></td>
                    <td align="center">注册号</td>
                    <td><?php echo $U['register'];?></td>
                    <td><?php echo $E['register'];?></td>
                </tr>
            <?php }?>
            <?php if(isset($E['readdress'])) {?>
                <tr onmouseover="this.className='on';" onmouseout="this.className='';">
                    <td align="center"><input type="checkbox" name="pass[]" value="readdress" checked/></td>
                    <td align="center">注册地址</td>
                    <td><?php echo $U['readdress'];?></td>
                    <td><?php echo $E['readdress'];?></td>
                </tr>
            <?php }?>
            <?php if(isset($E['reoffice'])) {?>
                <tr onmouseover="this.className='on';" onmouseout="this.className='';">
                    <td align="center"><input type="checkbox" name="pass[]" value="reoffice" checked/></td>
                    <td align="center">登记机关</td>
                    <td><?php echo $U['reoffice'];?></td>
                    <td><?php echo $E['reoffice'];?></td>
                </tr>
            <?php }?>
            <?php if(isset($E['retime'])) {?>
                <tr onmouseover="this.className='on';" onmouseout="this.className='';">
                    <td align="center"><input type="checkbox" name="pass[]" value="retime" checked/></td>
                    <td align="center">注册日期</td>
                    <td><?php if($U['retime']>0){echo date('Y-m-d',$U['retime']);}?></td>
                    <td><?php echo date('Y-m-d',$E['retime']);?></td>
                </tr>
            <?php }?>
            <?php if(isset($E['legalPerson'])) {?>
                <tr onmouseover="this.className='on';" onmouseout="this.className='';">
                    <td align="center"><input type="checkbox" name="pass[]" value="legalPerson" checked/></td>
                    <td align="center">法定代表人</td>
                    <td><?php echo $U['legalPerson'];?></td>
                    <td><?php echo $E['legalPerson'];?></td>
                </tr>
            <?php }?>
            <?php if(isset($E['mobilePhone'])) {?>
                <tr onmouseover="this.className='on';" onmouseout="this.className='';">
                    <td align="center"><input type="checkbox" name="pass[]" value="mobilePhone" checked/></td>
                    <td align="center">公司移动电话</td>
                    <td><?php echo $U['mobilePhone'];?></td>
                    <td><?php echo $E['mobilePhone'];?></td>
                </tr>
            <?php }?>
