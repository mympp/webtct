...
switch($action) {
	...
	case 'show':
		...
		if($submit) {
			...
			if(in_array('register', $pass) && isset($E['register'])) {
				$sql2 .= ",register='".addslashes($E['register'])."'";
			}
			if(in_array('readdress', $pass) && isset($E['readdress'])) {
				$sql2 .= ",readdress='".addslashes($E['readdress'])."'";
			}
			if(in_array('reoffice', $pass) && isset($E['reoffice'])) {
				$sql2 .= ",reoffice='".addslashes($E['reoffice'])."'";
			}
			if(in_array('retime', $pass) && isset($E['retime'])) {
				$sql2 .= ",retime='".addslashes($E['retime'])."'";
			}
			if(in_array('legalPerson', $pass) && isset($E['legalPerson'])) {
				$sql2 .= ",legalPerson='".addslashes($E['legalPerson'])."'";
			}
			if(in_array('mobilePhone', $pass) && isset($E['mobilePhone'])) {
				$sql2 .= ",mobilePhone='".addslashes($E['mobilePhone'])."'";
			}
