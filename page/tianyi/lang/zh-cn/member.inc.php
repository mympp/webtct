...
$L['tycase_title_add'] = '添加案例';
$L['tycase_title_edit'] = '修改案例';
$L['tycase_title'] = '项目案例';
$L['tycase_pass_title'] = '请填写案例名称';
$L['tycase_pass_thumb'] = '请上传案例图片';
$L['tycase_pass_fromdate'] = '请选择证书发证时间';
$L['tycase_reward_reason'] = '案例上传';
$L['tycase_punish_reason'] = '案例删除';
$L['tycase_msg_choose'] = '请选择案例';
