...
">荣誉资质</a></li>
<?php } ?>
<?php if(($MG['tycase_limit']>-1 && $MG['homepage']) || $show_menu) { ?>
<li class="side_a" onmouseover="v(this.id);" onmouseout="t(this.id);" id="tycase"><span class="f_r"><a href="tycase.php?action=add" class="m">添加</a></span><a href="tycase.php" class="<?php if($MG['tycase_limit']>-1 && $MG['homepage']) { ?>n<?php } else { ?>f<?php } ?>
">项目案例</a></li>
<?php } ?>
