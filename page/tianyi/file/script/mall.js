...
function Mshow(i) {
	if(i == 'detail') {
		...
		Dd('t_type').className = 'mall_tab_1';
		...
		Dd('t_comment').className = 'mall_tab_1';
		Dd('t_order').className = 'mall_tab_1';
		Dd('t_type').className = 'mall_tab_2';
		Dh('c_detail');
		Dh('c_comment');
		Dh('c_order');
		Ds('c_type');
...
function AddCart() {
	console.log(mallurl+'cart.php?itemid='+mallid+'&s1='+s_s[1]+'&s2='+s_s[2]+'&s3='+s_s[3]+'&a=');
	console.log(mallurl+'cart.php?itemid='+mallid+'&s1='+s_s[1]+'&s2='+s_s[2]+'&s3='+s_s[3]+'&a='+Dd('amount').value);
