<?php
require 'path/CloudsearchClient.php';
require 'path/CloudsearchDoc.php';
require 'path/CloudsearchIndex.php';
require 'path/CloudsearchSearch.php';
require 'path/CloudsearchSuggest.php';
