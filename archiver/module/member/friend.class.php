...
class friend {
    ...
    function friend() {
		...
		$this->db = &$db;
		$this->fields = array('listorder', 'userid','typeid','username','truename','style','company','career','telephone','mobile','homepage','email','msn','qq','ali','skype','note','addtime','bank','account','business','address','isdaili','daili_itemid');
    }
	...
	function add($post) {
		...
		//return "INSERT INTO {$this->table} ($sqlk) VALUES ($sqlv)";
		return $this->itemid;
	}
