...
<td>
<input name="type" type="radio" value="0" <?php if ($type==0) echo "checked" ?>/> 减少&nbsp;&nbsp;<input name="type" type="radio" value="1" <?php if ($type==1) echo "checked" ?>/> 增加&nbsp;&nbsp;<input name="type" type="radio" value="2" <?php if ($type==2) echo "checked" ?>/> 冻结&nbsp;&nbsp;<input name="type" type="radio" value="3" <?php if ($type==3) echo "checked" ?>/> 解冻&nbsp;&nbsp;

</td>
</tr>
<tr>
<td class="tl"><span class="f_red">*</span> 金额</td>
<td><input name="amount" id="amount" type="text" size="10" value='<?php echo $amount?>'/> <?php echo $DT['money_unit'];?> <span id="damount" class="f_red"></span></td>
</tr>
<tr>
