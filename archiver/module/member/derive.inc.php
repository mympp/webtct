...
*/
	...
	if($length>20&&$member['groupname']!='管理员'){
		echo "<script>alert('由于您不是管理员,所以一次最多只能导出20份简历')</script>";
		exit;
	}
	if($member['groupname']!='VIP会员'&&$member['groupname']!='管理员'&&$length>10){
		echo "<script>alert('由于您不是VIP会员,所以一次最多只能导出10份简历')</script>";
		exit;
	}
	$fileNameArr=array();
	//for循环开始
											...
											<tbody>
												<tr>
													<td valign="top" style="font-size:12px;">
														...
														<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" style="PADDING-RIGHT: 0px; PADDING-LEFT: 8px; PADDING-BOTTOM: 0px; MARGIN: 8px auto; LINE-HEIGHT: 22px;">
															<tbody>
																<tr>
																	<td colspan="2" height="30" width="100%" bgcolor="#F1F1F1" align="left">
																	<b>教育经历</b>
