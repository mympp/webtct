...
class spread {
    ...
    function spread() {
		...
		$this->db = &$db;
		$this->fields = array('mid','tid', 'word','price','currency','addtime','fromtime','totime','editor','edittime','username','company','status','note','total','spend','least','stype','spread_status');
    }
