...
<?php if($v['expert']) {?><span class="f_red">[专家]</span>&nbsp;|&nbsp;<?php } ?>票数 (<?php echo $v['vote'];?>) &nbsp;|&nbsp;<a href="<?php echo $EXT['linkurl'];?>redirect.php?mid=<?php echo $moduleid;?>&itemid=<?php echo $v['qid'];?>" target="_blank">原文ID:<?php echo $v['qid'];?></a>
</span>
