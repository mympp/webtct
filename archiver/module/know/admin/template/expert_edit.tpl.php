...
<tr>
<td class="tl"><span class="f_red">*</span> 相关人气</td>
<td>点击：<input name="post[hits]" type="text" size="5" value="<?php echo $hits;?>"/>
被提问：<input name="post[ask]" type="text" size="5" value="<?php echo $ask;?>"/>
回答：<input name="post[answer]" type="text" size="5" value="<?php echo $answer;?>"/>
采纳：<input name="post[best]" type="text" size="5" value="<?php echo $best;?>"/>
</td>
</tr>
<tr>
