...
<tr>
<td class="tl"><span class="f_red">*</span>是否推荐vip</td>
<td>
	<input type="radio" name="vip[promotion]" value="1" <?php if($promotion) echo 'checked'; ?> />是 &nbsp;&nbsp;&nbsp;&nbsp;
	<input type="radio" name="vip[promotion]" value="0" <?php if(!$promotion) echo 'checked'; ?> />否
</td>
</tr>
<tr>
