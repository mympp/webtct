...
<td>
<?php echo $v['company']; ?>&nbsp;
	<a href="javascript:void();" onclick="Dwidget('http://www.tecenet.com/file/game/bis/product-search.html?ID=<?php echo $v['company']; ?>&from=domestic', '搜索BIS库内容')">[device]</a>
</td>
<td>
	<?php echo $v['batchnum']; ?>&nbsp;
	<a href="javascript:void();" onclick="Dwidget('http://www.tecenet.com/file/game/bis/product-search.html?ID=<?php echo $v['batchnum']; ?>&from=domestic', '搜索BIS库内容')">[device]</a></td>
<td>
<?php if($v['username']) { ?>
