...
<div class="tt">应标管理中心</div>
<form method="post">
<table cellpadding="2" cellspacing="1" class="tb">
<tr>
<th width="160">用户名称</th>
<th >企业名称</th>
<th width="130">参与应标总数</th>
</tr>
...
<td> 
<a href="javascript:Dwidget('?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=showtalent&username=<?php echo $v['username'];?>','应标总数统计')"><?php echo $v['point'];?>个应标结果</a>&nbsp;</td>
</tr>
<?php }?>
</table>
