...
<td class="px11">
<a href="javascript:Dwidget('?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=showsupply&itemid=<?php echo $v['itemid'];?>','应标统计')"><?php echo $v['supplycount'];?>个应标</a>&nbsp;
<a href="javascript:Dwidget('?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=showpurchase&username=<?php echo $v['username'];?>','采购统计')"><?php echo $v['point'];?>采购管理</a>&nbsp;
<?php if($v['selitemid']>0) { ?>已有中标<?php }?></td>
<td>
