...
<?php echo type_select('announce', 1, 'post[typeid]', '设置信息分类为', $typeid, 'onchange="this.form.action=\'?moduleid='.$moduleid.'&file='.$file.'&action=set_type\';this.form.submit();"');?>
</div>
<div class="btns" style="color:red">
	温馨提示：<br/>1.无级别的为首页发布的，须审核；<br/>2.级别为<img src="admin/image/level_1.gif" title="1级" alt=""/>的为客服添加，须跟进；<br/>3.级别为<img src="admin/image/level_2.gif" title="1级" alt=""/>的为已跟进；<br/>4.级别为<img src="admin/image/level_3.gif" title="1级" alt=""/>的为其他部门跟进。
</div>
</form>
