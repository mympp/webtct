...
<tr>
<td class="tl">订单等待确认时间</td>
<td><input type="text" size="3" name="setting[order_wait_check]" value="<?php echo $order_wait_check; ?>" />&nbsp;小时</td>
</tr>

<tr>
<td class="tl">订单等待结束时间</td>
<td><input type="text" size="3" name="setting[order_wait_finish]" value="<?php echo $order_wait_finish; ?>" />&nbsp;小时</td>
</tr>
</table>
</div>
