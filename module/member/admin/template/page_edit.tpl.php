...
<?php echo deditor($moduleid, 'content', 'Destoon', '100%', 350);?><span id="dcontent" class="f_red"></span>
</td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 导航条推荐</td>
<td>
<input type="radio" name="post[elite]" value="0" <?php if($elite == 0) echo 'checked';?> /><label > 不推荐</label>
<input type="radio" name="post[elite]" value="1" <?php if($elite == 1) echo 'checked';?> /><label >  推荐</label>
</td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 外部链接</td>
<td>
<input type="text" name="post[url]" value="<?php echo $url;?>" />
</td>
</tr>
<tr>
