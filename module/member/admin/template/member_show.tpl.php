...
<!-- 公司设置 -->
<div class="tt">公司设置</div>
<table cellspacing="2" cellspacing="1" class="tb">
<tr>
<td class="tl">网店横幅</td>
<td><?php if(!empty($setting['banner'])) { ?><img src="<?php echo $setting['banner']; ?>" width="240px" height="80px" /> <?php } ?></td>
</tr>
<tr>
<td class="tl">首页模块设置</td>
<td><?php echo $setting['main_name']; ?></td>
</tr>
<tr>
<td class="tl">网站导航菜单</td>
<td><?php echo $setting['menu_name']; ?></td>
</tr>
<tr>
<td class="tl">侧栏模块设置</td>
<td><?php echo $setting['side_name']; ?></td>
</tr>
<tr>
<td class="tl">页面标题</td>
<td><?php echo $setting['seo_title']; ?></td>
</tr><tr>
<td class="tl">页面关键词</td>
<td><?php echo $setting['seo_keyword']; ?></td>
</tr><tr>
<td class="tl">页面描述</td>
<td><?php echo $setting['seo_description']; ?></td>
</tr>
</table>
<!-- 公司设置 end-->
