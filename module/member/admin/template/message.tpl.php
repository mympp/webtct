...
&nbsp;
收件账号：<input type="text" name="touser" value="<?php echo $touser;?>" size="10"/>
发件账号：<input type="text" name="fromuser" value="<?php echo $fromuser;?>" size="10"/>
...
<input type="submit" value=" 已 读 " class="btn" onclick="if(confirm('确定要标记已读选中信件吗？')){this.form.action='?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=edit_read'}else{return false;}"/>
<input type="submit" value=" 未 读 " class="btn" onclick="if(confirm('确定要标记未读选中信件吗？')){this.form.action='?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=edit_unread'}else{return false;}"/>
<input type="submit" value=" 已 转 " class="btn" onclick="if(confirm('确定要标记已转选中信件吗？')){this.form.action='?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=edit_send'}else{return false;}"/>
<input type="submit" value=" 未 转 " class="btn" onclick="if(confirm('确定要标记未转选中信件吗？')){this.form.action='?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=edit_unsend'}else{return false;}"/>
</div>
</form>
