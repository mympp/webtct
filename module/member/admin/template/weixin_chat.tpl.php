...
<tr>
<td>
	<textarea id="word" name="word" onkeydown="return chat_key(event);" title="按Ctrl+Enter发送"></textarea>
</td>
</tr>
<tr>
...
var selectOption = [
    '请选择快捷回复内容',
    '您好！感谢您一直以来对天成医疗网微信公众号：tianchengyiliao的关注！您还可以关注天成医疗网！pc端网址www.tecenet.com  移动端wap.tecenet.com',
    '你好，您可以到我司平台上搜索您要找的产品信息，根据搜索结果，选择合适您的产品。也可以在上班时间咨询在线客服，或致电4006173599咨询。'
];
function reasonSelect(){
    ...
    $wrap.html("<select style='width:100%' class='reason-select'>"+$options+"</select>");
