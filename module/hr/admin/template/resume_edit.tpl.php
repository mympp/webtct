...
<tr>
<td class="tl"><span class="f_red">*</span> 职位</td>
...
<td><?php echo ajax_area_select('post[areaid]', '请选择', $areaid);?> <span id="dareaid_1" class="f_red"></span></td>
</tr>
<tr>
...
<!--添加按钮-->
<tr>
<td class="tl"><span class="f_hid">*</span> 教育经历</td>
<td><input type="button" class="btn" value="添加/编辑" onclick="Dwidget('?moduleid=<?php echo $moduleid;?>&file=resume&action=add_all&type=education&education_id=<?php $_SESSION['education_id']=$education_id;echo $_SESSION['education_id'];?>&itemid=<?php echo $itemid;?>', '教育经历')"/></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 学生信息</td>
<td><input type="button" class="btn" value="添加/编辑" onclick="Dwidget('?moduleid=<?php echo $moduleid;?>&file=resume&action=add_all&type=student_information&information_id=<?php $_SESSION['information_id']=$information_id;echo $_SESSION['information_id'];?>&itemid=<?php echo $itemid;?>', '学生信息')"/></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 培训经历</td>
<td><input type="button"  class="btn" value="添加/编辑" onclick="Dwidget('?moduleid=<?php echo $moduleid;?>&file=resume&action=add_all&type=train&train_id=<?php $_SESSION['train_id']=$train_id;echo $_SESSION['train_id'];?>&itemid=<?php echo $itemid;?>', '培训经历')"/></td>
</tr>
<!--结束-->
<tr>
...
<!--新增按钮-->
<tr>
<td class="tl"><span class="f_hid">*</span> 语言能力描述</td>
<td><input type="button"  class="btn" value="添加/编辑" onclick="Dwidget('?moduleid=<?php echo $moduleid;?>&file=resume&action=add_all&type=language&language_id=<?php $_SESSION['language_id']=$language_id;echo $_SESSION['language_id'];?>&itemid=<?php echo $itemid;?>', '语言能力')"/></td>
</tr>
<!--结束-->
<tr>
...
<!--新增按钮-->
<tr>
<td class="tl"><span class="f_hid">*</span> 工作经历</td>
<td><input type="button"  class="btn" value="添加/编辑" onclick="Dwidget('?moduleid=<?php echo $moduleid;?>&file=resume&action=add_all&type=experience&experience_id=<?php $_SESSION['experience_id']=$experience_id;echo $_SESSION['experience_id'];?>&itemid=<?php echo $itemid;?>', '工作经历')"/></td>
</tr>
<!--结束-->
<tr>
