...
<?php if($template=='show-b'){ ?>
<?php $editortype=1;?>
<?php } ?>
<?php echo deditor($moduleid, 'content', $MOD['editor'], '98%', 350);?>
...
<tr>
<td class="tl"><span class="f_red">*</span> 简单介绍</td>
<td><textarea name="post[introduce]" rows="5" cols="40"><?php echo $introduce;?></textarea></td>
</tr>
<tr>
