...
$sorder  = array($L['order'], $L['order_auto'], $L['order_reward'], $L['order_answer'], $L['order_hits'], '按点赞从高到低', '按点踩从高到低', '按发布从新到老');
$dorder  = array($MOD['order'], '', 'credit DESC', 'answer DESC', 'hits DESC', 'agree DESC', 'against DESC', 'edittime DESC');
