...
<?php  $rip=randip();?>
<input type="text" name="post[ip]" value="<?php if($itemid){echo $ip;}else{echo $rip; }?>" id="hip"/>
<input type="text" name="post[editor]" value="<?php echo $editor;?>" id="heditor"/>
	<script type="text/javascript" src="<?php echo $DT_STATIC;?>file/script/randname.js"></script>
	<script type="text/javascript">
  <?php if(!$itemid){?>Dd('heditor').value=randname();<?php } ?>
	</script>
</td>
</tr>
<tr>
...
<tr>
<td class="tl"><span class="f_hid">*</span> 点赞总数</td>
<td><input type="text" size="22" name="post[agree]" value="<?php echo $agree;?>"/></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 踩踏总数</td>
<td><input type="text" size="22" name="post[against]" value="<?php echo $against;?>"/></td>
</tr>
<?php if($DT['city']) { ?>
<tr>
