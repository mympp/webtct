...
$menus = array (
    ...
    array('SEO优化'),
    array('权限收费'),
    array('服务需求字段', 'javascript:Dwidget(\'?file=fields&tb=job\', \'服务需求定义字段\');'),
    array('工程师字段', 'javascript:Dwidget(\'?file=fields&tb=resume\', \'工程师定义字段\');'),
