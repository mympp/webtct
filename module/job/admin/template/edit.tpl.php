...
<div class="tt"><?php echo $action == 'add' ? '添加' : '修改';?>服务</div>
...
<?php } ?>
<tr>
<td class="tl"><span class="f_hid">*</span> 医院/部门</td>
...
<tr>
<td class="tl"><span class="f_red">*</span> 需要人数</td>
<td><input name="post[total]" type="text" id="total" size="6" value="<?php echo $total;?>"/> 人 (填0为若干)</td>
</tr>
<tr>
<td class="tl"><span class="f_red">*</span> 悬赏水平</td>
...
<tr>
<td class="tl"><span class="f_red">*</span> 团队形式</td>
<td>
<?php
...
<tr>
<td class="tl"><span class="f_red">*</span> 需求描述</td>
...
<?php } ?>
<tr>
<td class="tl"><span class="f_hid">*</span> 服务需求处理</td>
<td>
...
<tr>
<td class="tl"><span class="f_hid">*</span> 报名次数</td>
<td><input name="post[apply]" type="text" size="10" value="<?php echo $apply;?>"/></td>
</tr>
<tr>
