...
<tr>
<td class="tl"><span class="f_red">*</span> 发布者账号</td>
...
<tr>
<td class="tl"><span class="f_red">*</span> 发布者公司</td>
...
<?php if($DT['im_msn']) { ?>
<tr>
<td class="tl"><span class="f_hid">*</span> 发布者MSN</td>
<td class="tr"><input name="post[msn]" type="text" size="30" value="<?php echo $msn;?>"/></td>
</tr>
<?php } ?>
<?php if($DT['im_skype']) { ?>
<tr>
<td class="tl"><span class="f_hid">*</span> 发布者Skype</td>
