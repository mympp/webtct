...
<select name="homepages">
	<option value="0"  <?php if(!$homepages)  echo ' selected'; ?>>默认
	<option value="1" <?php if($homepages==1)  echo ' selected'; ?>>有官网的
	<option value="2" <?php if($homepages==2)  echo ' selected'; ?>>无官网的
</select>
...
账号：<input type="text" name="username" value="<?php echo $username?>" size=8>
</td>
</tr>
</table>
</form>
...
<td align="left">&nbsp;<?php echo area_pos($v['areaid'], '');?>/<a href="<?php echo $v['linkurl'];?>" target="_blank"><?php echo $v['title'];?></a><?php echo $v['pnum'];?><?php if($v['vip']) {?> <img src="<?php echo DT_SKIN;?>image/vip.gif" title="<?php echo VIP;?>:<?php echo $v['vip'];?>"/><?php } ?>

<?php if($v['homepage']) {?><a href="<?php echo $v['homepage'];?>" target="_blank">官网</a><?php }?>
</td>
<td>
<?php if($v['username']) { ?>
...
var selectOption = [
    '请选择理由',
    '您好，请完善厂家品牌信息。感谢您对天成医疗网的关注与支持。',
    '您好，请上存有效的公司logo图片，感谢您对天成医疗网的关注与支持。',
    '您好，请上存有效的公司logo图片，和填写准确的厂家品牌名称，感谢您对天成医疗网的关注与支持。',
    '您好，由于您的信息不详细，系统无法审核通过，麻烦您把信息完善好（如：logo、详细说明等）。感谢您对天成医疗的关注与支持。'
];
</script>
