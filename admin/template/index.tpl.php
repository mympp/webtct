...
<title>管理中心 - <?php echo $DT['sitename']; ?> - Powered By TECENET B2B <?php echo $edition;?> V<?php echo DT_VERSION; ?> R<?php echo DT_RELEASE;?> <?php echo strtoupper(DT_CHARSET);?> <?php echo strtoupper(DT_LANG);?></title>
<meta name="robots" content="noindex,nofollow"/>
<meta name="generator" content="TECENET B2B - www.TECENET.com"/>
...
<frame name="main" noresize scrolling="yes" src="?file=count&rand=<?php echo $DT_TIME;?>">
</frameset>
</html>