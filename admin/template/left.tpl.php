...
<title>管理中心 - <?php echo $DT['sitename']; ?> - Powered By TECENET B2B V<?php echo DT_VERSION; ?> R<?php echo DT_RELEASE;?></title>
...
<a href="?file=count" target="_top"><img src="admin/image/reload.gif" width="8" height="8" title="刷新(返回后台起始页)"/></a>&nbsp;
...
<div id="menu">
	...
	<dd onclick="c(this);"><a href="?file=count">系统首页</a></dd>
