...
<tr>
<td class="tl"><span class="f_hid">*</span> 内容过滤</td>
<td><textarea name="contentreplace" type="text" rows="6" cols="50"/><?php echo $contentreplace;?></textarea>一行以个以|||隔开，例如：沉默|||爆发！就是将沉默替换为爆发</td>
</tr>
<tr>
<td class="tl"><span class="f_red">*</span>相关图片</td>
<td><textarea name="thumb" rows="6" cols="50" id="thumb"><?php echo $thumb;?></textarea></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 初始值</td>
<td><textarea name="fieldvalue" type="text" rows="6" cols="50"/><?php echo $fieldvalue;?></textarea></td>
</tr>
<tr>
