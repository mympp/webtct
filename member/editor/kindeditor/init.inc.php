...
#$editor .= 'autoHeightMode : true,';//开通编辑器自动高度
$editor .= 'afterBlur:function(){this.sync();},';	//bluewolf修复IE浏览器无法获得内容的BUG
...
if($toolbarset == 'Destoon') {
	...
	$editor .= "items : [".(defined('DT_ADMIN') ? "'source', '|', " : "")."'wordpaste', 'plainpaste', '|', 'bold', 'forecolor', 'fontsize', 'link', 'unlink', 'multiimage', 'justifyleft', 'justifycenter', 'justifyright', 'insertfile', ".($moduleid == 18 ? "'emoticons', " : "")."'fullscreen'],";
} else if($toolbarset == 'Basic') {
	$editor .= "items : [".(defined('DT_ADMIN') ? "'source', '|', " : "")."'bold', 'forecolor', 'fontsize', 'link', 'unlink', 'image', 'justifyleft', 'multiimage', 'justifycenter', 'justifyright', ".($moduleid == 18 ? "'emoticons', " : "")."'fullscreen'],";
} else if($toolbarset == 'Message') {
	$editor .= "items : [".(defined('DT_ADMIN') ? "'source', '|', " : "")."'wordpaste', 'plainpaste', '|', 'bold', 'forecolor', 'fontsize', 'link', 'unlink', 'multiimage', 'emoticons', 'justifyleft', 'justifycenter', 'justifyright', 'insertfile', ".($moduleid == 18 ? "'emoticons', " : "")."'fullscreen'],";
